            ...
            <div className="max-w-4xl w-full grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-extrabold  text-[#4E56C0] leading-tight fade-in-up">
                        Hi, I'm <br></br> <span className="text-[#4E56C0]">Ahmad</span>
                    </h1>
                    <p datatype="typing" className="mt-6 text-lg text-slate-700 leading-relaxed">
                        <TypeIt
                            options={{
                                strings: [
                                    "Software Engineer with around 5 years of experience focusing on backend development and business logic implementation."
                                ],
                                speed: 25,
                    ...
                    <div className="mt-8 flex gap-8 item-center border-l-4 border-purple-200 pl-6">
                        ...
                        <div>
                            <span className="block text-2xl font-bold  text-[#2e1065]">10+</span>
                            <span className="text-xs uppercase tracking-wider text-slate-500 font-semibold">Projects</span>
                        </div>
                    </div>
